...
// Helpers
// ──────────────────────────────────────────────────────────────────────────────
function getProjectName(config, input) {
    if (config.mlApp)
        return config.mlApp;
...
function getToolSpanKey(sessionID, callID) {
...
// Plugin export
// ──────────────────────────────────────────────────────────────────────────────
export const DatadogLLMObsPlugin = async (input) => {
        ...
        "tool.execute.before": async (hookInput, hookOutput) => {
            try {
                ...
                toolContexts.set(key, {
                    ...
                    args: config.recordInputs ? hookOutput.args : undefined,
                });
            }
            catch (error) {
